...
\
  ...
  { ZAP_LONG_DEFAULTS_INDEX(8), 0x00000000, 8, ZAP_TYPE(NODE_ID), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* LastConfiguredBy */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 12, 133 }, \
  { ZAP_CLUSTER_INDEX(12), 7, 112 }, \
}
...
#define FIXED_DEVICE_TYPES {{0x00000016,1},{0x0000010D,1}}
